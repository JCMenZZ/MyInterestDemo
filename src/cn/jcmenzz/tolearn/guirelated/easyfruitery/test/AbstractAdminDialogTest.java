package cn.jcmenzz.tolearn.guirelated.easyfruitery.test;

import cn.jcmenzz.tolearn.guirelated.easyfruitery.view.AbstractAdminDialog;
...
public class AbstractAdminDialogTest extends AbstractAdminDialog {
    ...
    public void queryFruitItem() {
        ...
        String[][] tbody = new String[][]{{"1", "苹果", "5.0", "kg"}, {"2", "葡萄", "3.2", "斤"}, {"3", "雪梨", "3.8", "斤"}, {"4", "泰国大榴莲", "120", "个"}};
